...
// @Service
// @Transactional
// public class MessageServiceImpl implements AccountService {
//
// @Autowired
...
// @Cacheable(cacheNames = "accounts", key = "#mobile", unless = "#result ==
// null")
// public Account findUserWithPermissions(String mobile, String password, int
// status) throws EthraaException {
//
// Account acc = null;
// try {
